...
from utils.datasets2 import create_dataloader2, getLblString
from utils.general import coco80_to_coco91_class, check_dataset, check_file, check_img_size, check_requirements, \
    box_iou, non_max_suppression, scale_coords, xyxy2xywh, xywh2xyxy, set_logging, increment_path, colorstr
from utils.metrics import ap_per_class, ConfusionMatrix, getStemString
...
def test(data,
    ...
    ################################################################################################################
    ################################################################################################################    
    dtloadr2_list = list(tqdm(dataloader2, desc=s))
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        ################################################################################################################
        ################################################################################################################    
        targets2 = dtloadr2_list[batch_i][1]
